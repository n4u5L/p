...
typedef lxb_status_t (*lxb_dom_node_cb_removing_f)(lxb_dom_node_t* removed_node,
                                                   lxb_dom_node_t* old_parent);

typedef lxb_status_t (*lxb_dom_node_cb_moving_f)(lxb_dom_node_t* moved_node,
                                                 lxb_dom_node_t* old_parent);
...
typedef lxb_status_t (*lxb_dom_node_cb_set_value_f)(lxb_dom_node_t* node,
